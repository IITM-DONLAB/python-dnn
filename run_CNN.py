...
import cPickle, gzip, os, time, log
...
from io.file_io import  read_dataset
...
def runCNN(configFile):
	...
	conv_configs,conv_layer_configs = load_conv_spec(model_config['conv_nnet_spec'],model_config['batch_size'],
				model_config['input_shape'])
	
	mlp_configs = load_mlp_spec(model_config['hidden_nnet_spec']);
	...
	cnn = CNN(numpy_rng=numpy_rng, theano_rng = theano_rng, model_configs, conv_configs,conv_layer_configs,mlp_configs)
